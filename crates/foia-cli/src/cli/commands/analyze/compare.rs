...
struct BackendConfig {
    name: String,
    backend_type: foia_analysis::ocr::OcrBackendType,
    use_gpu: bool,
}
...
fn parse_backend_configs(backends_str: &str) -> Result<Vec<BackendConfig>, String> {
    use foia_analysis::ocr::OcrBackendType;
        ...
        for (i, &page) in pages.iter().enumerate() {
            let result = match config.backend_type {
                ...
                OcrBackendType::Gemini => {
                    use foia_analysis::ocr::GeminiBackend;
                ...
                OcrBackendType::Groq => {
                    use foia_analysis::ocr::GroqBackend;
